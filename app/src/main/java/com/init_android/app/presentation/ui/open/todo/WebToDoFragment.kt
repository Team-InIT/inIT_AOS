...
import com.init_android.databinding.FragmentWebToDoBinding
import com.playtogether_android.app.presentation.base.BaseFragment


class WebTodoFragment : BaseFragment<FragmentWebToDoBinding>(R.layout.fragment_web_to_do) {
    ...
    private fun initNetwork() {
        ...
        todoViewModel.postReadWebToDo(requestProjectMember)
        toDoPlanAdapter = ToDoPlanAdapter()
        binding.rvWeb.adapter = toDoPlanAdapter
